...
const earthDay = textureLoader.load("./earth/day.jpg")
earthDay.colorSpace = THREE.SRGBColorSpace
earthDay.anisotropy = 8
const earthNight = textureLoader.load("./earth/night.jpg")
earthNight.colorSpace = THREE.SRGBColorSpace
earthNight.anisotropy = 8
const earthSpecularClouds = textureLoader.load("./earth/specularClouds.jpg")
earthSpecularClouds.anisotropy = 8
// Mesh
...
const earthMaterial = new THREE.ShaderMaterial({
    ...
    uniforms:
    {
        uDayTexture: new THREE.Uniform(earthDay),
        uNightTexture: new THREE.Uniform(earthNight),
        uSpecularCloudsTexture: new THREE.Uniform(earthSpecularClouds),
