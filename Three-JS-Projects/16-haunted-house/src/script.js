...
const floorColorTexture = textureLoader.load("floor/sand_rocks/coast_sand_rocks_02_diff_1k.webp");
const floorARMTexture = textureLoader.load("floor/sand_rocks/coast_sand_rocks_02_arm_1k.webp");
const floorNormalTexture = textureLoader.load("floor/sand_rocks/coast_sand_rocks_02_nor_gl_1k.webp");
const floorDisplacementTexture = textureLoader.load("floor/sand_rocks/coast_sand_rocks_02_disp_1k.webp");
...
// Wall
const wallColorTexture = textureLoader.load("wall/castle_brick/castle_brick_broken_06_diff_1k.webp");
const wallARMTexture = textureLoader.load("wall/castle_brick/castle_brick_broken_06_arm_1k.webp");
const wallNormalTexture = textureLoader.load("wall/castle_brick/castle_brick_broken_06_nor_gl_1k.webp");
...
gui.add(floor.material, 'displacementScale').min(0).max(1).step(0.001).name('Floor Displacement')
gui.add(floor.material, 'displacementBias').min(-1).max(1).step(0.001).name('Floor Disp. Bias')
...
// Fog
//scene.fog = new THREE.Fog(0xff0000, 5, 15);
scene.fog = new THREE.FogExp2(0x02343f, 0.07);
...
const tick = () => {
  ...
  ghost1.position.y = Math.sin(ghost1Angle) * Math.sin(ghost1Angle) * 2.23 * Math.sin(ghost1Angle) * 1.9

  const ghost2Angle = - elapsedTime * 0.71
  ghost2.position.x = Math.cos(ghost2Angle) * 5
  ghost2.position.z = Math.sin(ghost2Angle) * 5
  ghost2.position.y = Math.sin(ghost2Angle) * Math.sin(ghost2Angle) * 2.07 * Math.sin(ghost2Angle) * 2.6

  const ghost3Angle = - elapsedTime * 0.36
  ghost3.position.x = Math.cos(ghost3Angle) * 6
  ghost3.position.z = Math.sin(ghost3Angle) * 6
  ghost3.position.y = Math.sin(ghost3Angle) * Math.sin(ghost3Angle) * 1.9 * Math.sin(ghost3Angle) * 3
  // Update controls
  controls.update();
